    ...
    <div className="w-[212px] h-full bg-white border-r border-gray-100" style={{ padding: '20px 16px' }}>
      ...
      <div className="mb-4">
        ...
        <div className="space-y-1">
          {/* Default - Selected */}
          <div className="flex items-center gap-1 px-2 py-1 bg-[rgba(28,28,28,0.05)] rounded-lg relative">
            <div className="w-1 h-4 bg-[#1C1C1C] rounded-sm absolute left-0 top-1/2 transform -translate-y-1/2"></div>
      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          <div className="ml-7 space-y-1">
            ...
            {/* Campaigns */}
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg">
              <span className="text-sm font-normal text-[#1C1C1C]">Campaigns</span>
            </div>
            
            {/* Documents */}
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg">
              <span className="text-sm font-normal text-[#1C1C1C]">Documents</span>
            </div>
            
            {/* Followers */}
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg">
              <span className="text-sm font-normal text-[#1C1C1C]">Followers</span>
            </div>
          </div>
